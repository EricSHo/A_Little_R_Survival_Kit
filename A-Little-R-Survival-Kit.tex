...
\texttt{ggplot2} graphical systems will be discussed. Part II includes
use cases of common statistical tests and intermediate-level R functions
that leverage the concepts discussed in Part I.
...
\begin{itemize}
\item
  A variable name can be as short as one character to way longer than a
  normal person wishes (10,000 characters!).
\item
  My suggestion is to give variables meaningful names that can help a
  bunch for you or someone to comprehend the the code. For instance, in
  a problem about heart rate, use \texttt{zone2} instead of \texttt{z}
  or even worse \texttt{x}.
\item
...
\item
  ...
  remaining silence, costing time to identify the issue. Therefore, the
  rule of thumb is to exercise self-discipline not to choose R function
...
variable contain a single value, and a composite variable consists of a
...
expression on the right-hand side, if no error, is stored in the named
variable on the left-hand side. In RStudio, you can see the variable
name and its associated value under the \textbf{Environment} tab, which
usually occupies the top right quadrant of the RStudio desktop.
...
respectively. Note that you must not include spaces in a scientific
...
exponentiation operators perform exactly the same function. Here are
some examples:
...
R also support text values, which is in \texttt{character} data type. To
define a character value, you need to use a pair of quotes to embrace
...
characters, including spaces and punctuations, of a character variable.
E.g.,
...
vector. We will discuss more about indexing below.
...
data types. In the example below, even the first and third values are
entered as numeric, R coerces them into text \texttt{"1"} and
\texttt{"0"}.
...
\texttt{mean()} and \texttt{sd()} are built-in functions that calcuate
...
available). Let's take a look at an R's built-in data frame
\texttt{iris}:
...
like a X-Y Cartesian system. Rows are automatically indexed (numbered),
...
Note that the \texttt{head()} above is used to limit the number rows
...
names in vectors by the \texttt{c(...)} function, which
...
example, \texttt{iris\$Species}, which is equivalent of
\texttt{iris{[},5{]}},
...
We can use the \texttt{data.frame()} function with the concept of vector
to create a dataset in data frame format. For example, a study collected
10 fish with their sex and age. To create the data frame, vectors must
be created to represent each variable (column). Here's the R code:
...
Find out more information about \texttt{summary()} function below
Section~\ref{sec-summary-function}.

It is almost done. There is one nuance. In the current form,
\texttt{sex} is a character variable so its summary statistics are a bit
strange. Most often, variable likes that should be categorical/nominal.
Therefore, we need to convert \texttt{sex} into a \texttt{factor}
Section~\ref{sec-factor-levels}. Here's the revised code:
...
Median and quantile are called robust statistics, as they impede
outliers' influence.
...
points below or above the lower or upper whisker are considered as
outliers.
...
all variables before analysis. It can be done by using the
...
of a numeric variable, etc. Here we will discuss a few R functions to do
that, and we coin them inspection functions.
...
The \texttt{range()} prints the minimum and maximum values of an object
\footnote{Note that \texttt{range()} works for non-numeric vector, but
  we will skip such special operation.}.
...
The function set up the context of a data frame so it spares you from
using the \texttt{\$} to access the columns of a data frame, as it often
leads to longer commands, which makes harder to comprehend and
troubleshooting. It is also commonly used together with a function
applied to one or more columns. E.g., the median of
\texttt{Petal.Width}. It can done in two ways:
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-5-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-6-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-8-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-9-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-10-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-11-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-12-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-13-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-14-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-15-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-16-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-17-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-18-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-19-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-20-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-22-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-23-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-24-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-25-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-26-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-27-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-28-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-29-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-30-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-32-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-33-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-34-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-35-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-36-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-37-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-38-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-39-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-40-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-42-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-43-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03-Data-Visualization_files/figure-pdf/fig-3-44-1.pdf}}
